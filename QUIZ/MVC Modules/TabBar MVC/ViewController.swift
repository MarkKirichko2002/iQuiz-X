    ...
    func startSpeechRecognization() {
        ...
        task = (speechReconizer?.recognitionTask(with: request, resultHandler: { [self] (response, error) in
            ...
            case _ where self.text.contains("Планет") || self.text.contains("планет") || self.text.contains("Космос") || self.text.contains("космос"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizPlanets(), category: quizViewModel.categories[0].categories[0], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Истори") || self.text.contains("истори"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizHistory(), category: quizViewModel.categories[1].categories[1], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Анатоми") || self.text.contains("анатоми"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizAnatomy(), category: quizViewModel.categories[2].categories[2], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Спорт") || self.text.contains("спорт"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizSport(), category: quizViewModel.categories[3].categories[3], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Игр") || self.text.contains("игр"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizGames(), category: quizViewModel.categories[4].categories[4], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Интеллект") || self.text.contains("интеллект"):
                ...
                self.player.Sound(resource: "IQ.mp3")
                self.sound = "IQ.mp3"
                self.quizViewModel.GoToStart(quiz: QuizIQ(), category: quizViewModel.categories[5].categories[5], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Эконом") || self.text.contains("эконом"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizEconomy(), category: quizViewModel.categories[6].categories[6], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Географи") || self.text.contains("географи"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizGeography(), category: quizViewModel.categories[7].categories[7], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Экологи") || self.text.contains("экологи"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizEcology(), category: quizViewModel.categories[8].categories[8], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Физ") || self.text.contains("физ"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizPhysics(), category: quizViewModel.categories[9].categories[9], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Хим") || self.text.contains("хим"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizChemistry(), category: quizViewModel.categories[10].categories[10], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Информа") || self.text.contains("информа"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizInformatics(), category: quizViewModel.categories[11].categories[11], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Литера") || self.text.contains("литера"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizLiterature(), category: quizViewModel.categories[12].categories[12], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Дорог") || self.text.contains("дорог"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizRoadTraffic(), category: quizViewModel.categories[13].categories[13], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Swift") || self.text.contains("swift"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizSwift(), category: quizViewModel.categories[14].categories[14], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Мор") || self.text.contains("мор"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizUnderwater(), category: quizViewModel.categories[15].categories[15], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Шахмат") || self.text.contains("шахмат"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizChess(), category: quizViewModel.categories[16].categories[16], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Halloween") || self.text.contains("halloween"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizHalloween(), category: quizViewModel.categories[17].categories[17], storyboard: self.storyboard, view: self.view)
            ...
            case _ where self.text.contains("Рождеств") || self.text.contains("рождеств"):
                ...
                self.quizViewModel.GoToStart(quiz: QuizNewYear(), category: quizViewModel.categories[18].categories[18], storyboard: self.storyboard, view: self.view)
