...
struct NewsCategories {
    ...
    static let categories = [
        NewsCategoryModel(id: 1, name: "Главное", icon: "newspaper", sound: "newspaper.mp3", endpoint: .general, articlesCount: 0, voiceCommand: "главн"),
        ...
        NewsCategoryModel(id: 3, name: "Спорт", icon: "sport.jpeg", sound: "sport.wav", endpoint: .sport, articlesCount: 0, voiceCommand: "спорт"),
        ...
        NewsCategoryModel(id: 6, name: "Развлечения", icon: "", sound: "entertainment.mp3", endpoint: .entertainment, articlesCount: 0, voiceCommand: "развлеч")
    ]
